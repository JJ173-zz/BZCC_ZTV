...
/* Events */
void ZTVJourney::AddObject(Handle h, bool IsStartingVehicles, Handle* pRecyclerHandles)
{
...
void ZTVJourney::DeleteObject(Handle h)
{
	char ObjClass[64];
	GetObjInfo(h, Get_GOClass, ObjClass);
...
/* Main Functions */
void ZTVJourney::Setup()
{

}

void ZTVJourney::Execute(bool* pTeamIsSetUp, Handle* pRecyclerHandles)
{
	m_TurnCounter++;
...
void ZTVJourney::DoGenericStrategy(bool* pTeamIsSetUp, Handle* pRecyclerHandles)
{
...
void ZTVJourney::SetupExtraVehicles(void)
{
...
Handle ZTVJourney::BuildStartingVehicle(int aTeam, int aRace, const char* ODF1, const char* ODF2, const char* Where, int aGrp)
{
	char TempODF[64];
...
/* CPU Functions */
void ZTVJourney::AddCPUScav(Handle scavHandle)
{
...
void ZTVJourney::SetCPUAIPlan(AIPType Type)
{
...
/* SubMission */
EjectKillRetCodes ZTVJourney::PlayerEjected(void)
{
	return DoEjectPilot;
}

EjectKillRetCodes ZTVJourney::PlayerKilled(int)
{
	return DoEjectPilot;
}
