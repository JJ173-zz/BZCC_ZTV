...
const char* StratInstant::GetNextRandomVehicleODF(int Team)
{
...
const char *StratInstant::GetInitialPlayerVehicleODF(int Team)
{
	return GetPlayerODF(Team);
}
...
PreSnipeReturnCodes StratInstant::PreSnipe(const int curWorld, Handle shooterHandle, Handle victimHandle, int ordnanceTeam, const char* pOrdnanceODF)
{
